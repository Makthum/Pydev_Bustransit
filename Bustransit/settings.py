# Django settings for Bustransit project.
import os.path
import djcelery
...
STATIC_ROOT = '/home/zarroc/workspace/bustransit/Bustransit/static'
...
ROOT_URLCONF = 'Bustransit.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'Bustransit.wsgi.application'
